*** Settings ***
Documentation    DEF-004 - Defeito Fora Da Garantia + Reparo Reprovado + Máquina Funcional.
...
${EVIDENCE_SCENARIO}   HOT-INV-DEF-004
${EVIDENCE_DIR}        ${EVIDENCE_ROOT}${/}${EVIDENCE_SCENARIO}

*** Test Cases ***
HOT-INV-DEF-004 - Defeito Fora Da Garantia Reparo Reprovado Maquina Funcional
    [Tags]    HOT    INVENTARIO    DEFEITO    DEF-004    FORA-GARANTIA    REPARO-REPROVADO    MAQUINA-FUNCIONAL    E2E

    ${massa}=    Gerar Massa Do Ativo DEF-004
    ...
    Informar Equipamento Fora Da Garantia Com Reparo Reprovado Maquina Funcional    ${ORCAMENTO}
