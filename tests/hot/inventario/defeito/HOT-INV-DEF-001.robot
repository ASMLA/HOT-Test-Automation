*** Settings ***
Documentation    DEF-001 reconstruído a partir do Playwright Codegen real. Nenhum locator ambíguo é inventado.
...
*** Test Cases ***
HOT-INV-DEF-001 - Defeito Dentro Da Garantia Sem Peça
    [Tags]    HOT    INVENTARIO    DEFEITO    DEF-001    GARANTIA    E2E    CODEGEN
    ...
    Informar Equipamento Dentro Da Garantia
    Validar Aguardando Peca

    Informar Que A Peça Está Disponível
